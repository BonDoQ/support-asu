...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="container">
        ...
        <input type="text" class="form-control req-min req-full-name" minlength="3" maxlength="60" placeholder="Full Name">
        <input type="text" class="form-control req-min req-email" minlength="3" maxlength="40" placeholder="Email address">
        <input type="text" class="form-control req-numeric req-min" minlength="3" maxlength="14" placeholder="Mobile">
        ...
        <div>
			...
			<input style="display:none;" type="file" id="FileID">
        </div>
      <button href="#myModal" class="btn btn-primary" id="Button" type="submit" data-toggle="modal">Send</button>
      </form>
        </div><!--/span-->
        <!--description body-->
